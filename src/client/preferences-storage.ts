...
const PREFERENCES_KEY_PREFIX = "botinvest:onboarding:v1";
...
export function readAccountPreferences(
  ...
  try {
    ...
    ) as { version?: number; preferences?: unknown } | null;
...
export function removeLegacyPreferences(_storage = browserStorage()) {}
