...
export const candidateSchema = z.object({
  ...
  providerLiquidityRank: z.number().int().positive().optional(),
  providerLiquidityRankTotal: z.number().int().positive().optional(),
  marketCapRank: z.number().int().positive().optional(),
  marketCapRankSource: z.literal("lumora").optional(),
  ...
  lumoraRoute: z.string().min(1).optional(),
